  ...
  return $as_sci_Map(namedExpressions.map__F1__sc_IterableOps(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, namedExpressions$1) {
    return (function(x0$1$2) {
      ...
      if ((x0$1 !== null)) {
        ...
        $m_Lcalculator_Signal$();
        var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this$1, exprSig$1, namedExpressions$1$1) {
          return (function() {
            return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(exprSig$1.apply__O()), namedExpressions$1$1)
          })
        })($this, exprSig, namedExpressions$1));
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, delta$1, b$1, a$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) > 0)) {
        ...
        var this$12 = $m_s_Predef$().Set$3;
        var array$1 = [((-$uD(b$1.apply__O())) / (2 * $uD(a$1.apply__O())))];
        var elems$1 = new $c_sjsr_WrappedVarArgs().init___sjs_js_Array(array$1);
